...
const AddHotel = () => {
  ...
  const handleAddData = async (event) => {
    ...
    if (!HotelName || !Hoteltype || !HotelCity || !HotelAddress || !HotelDistance || !Hoteltitle || !Hoteldesc || !HotelcheapestPrice) {
      alert("Please fill in all fields.");
      return;
    }

    if (isNaN(HotelDistance) || isNaN(HotelcheapestPrice)) {
      alert("Distance and cheapest price must be a number.");
      return;
    }
  ...
  return (
    <>
      <Navbar />
      <Header type="list" />
      <div className="addHoteHhomeContainer">
