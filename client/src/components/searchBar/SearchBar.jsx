...
const SearchBar = ({
  ...
  const updateDateRangeProperty = (item) => {
    setDate([item.selection]);

    if (setSelecteDateRange) setSelecteDateRange([item.selection]);
  };

  return (
    <div
      className={`vehicleHeaderSearch ${filterPage ? "headerSearchFilterPage" : ""}`}
    >
      <div className="vehicleHeaderSearchItem">
      ...
      <div className="vehicleHeaderSearchItem">
        ...
        {openDate && (
          <DateRange
            ...
            onChange={updateDateRangeProperty}
